...
export default function Homecontent() {
  ...
  function handleShow(e) {
    setShow(true);
    let a = e.target.id;
    setMlink(Movdata[a[0]].movie[a[1]]);
  }
  ...
  const handleSmall = (e) => {
    ...
    // e.target.style.visibility = "visable";
  ...
  return (
    <div style={{ backgroundColor: "#141414" }}>
      <div style={{ marginLeft: "100px" }}>
        {Movdata.map(({ title, movie }, i) => {
          return (
            <>
              <Row>
                <h5 className="mt-3" style={{ color: "white" }}>{title}</h5>
                ...
                <Carousel
                  ...
                  centerMode
                >
                  {movie.map(({ thumbnail, genre, age, length, yt }, k) => {
                    return (
                      <>
                        <Col
                              ...
                              <div>
                                <Row className="mt-3">
                                  ...
                                  <Col
                                    ...
                                    style={{ width: "100px" }}
                                  >
                                    <div   id={`${i}${k}`} style={{ marginLeft: "70px" }}>
                                      {/* <IconContext.Provider
                                        value={{ color: "white", size: "2em" }}
                                      >
                                        <FaRegArrowAltCircleDown />
                                      </IconContext.Provider> */}
                                      <img  id={`${i}${k}`} style={{width:"30px"}} src={Arrow}></img>
                                    </div>
                                  </Col>
                                </Row>
                                <div
                  ...
                  <Row>
                    <Col xs={8} style={{marginLeft:"20px" , marginTop:"10px"}}>
                      <div style={{ display: "flex" }}>
                        ...
                        <p className="mx-2" style={{color:"grey"}}>{mlink.length} </p>
                        <p
                          className="mx-3 px-2"
                    ...
                    <p style={{color:"grey" , padding:"0px"}}>Genre:  <text style={{color:"white"}}>{mlink.genre[0]},{mlink.genre[1]},{mlink.genre[2]}</text> </p>
                  </div>
                    </Col>
                  </Row>
                  <div>
                    {mlink.type === "Tv Show" && (
                      <div style={{marginLeft:"20px",color:"grey"}}>
                        ...
                        <Link style={{textDecoration:"none"}} to={"/play?link="+mlink.yt}>
                        <Row className={Hstyle.hhov} style={{color:"white",marginBottom:"10px"}}>
                          <Col>
                          <img style={{width:"200px",height:"100px"}} src={mlink.thumbnail}></img>
                          </Col>
