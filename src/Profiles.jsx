    ...
    <div className={Mstyle.b}>
      ...
      >
        {load ? <>
          ...
          ></img>
                </>:<><img className={Mstyle.p}
                src="https://occ-0-2794-2219.1.nflxso.net/dnm/api/v6/190hWN2d019C9txTON9tvTFtefw/AAAABVr8nYuAg0xDpXDv0VI9HUoH7R2aGp4TKRCsKNQrMwxzTtr-NlwOHeS8bCI2oeZddmu3nMYr3j9MjYhHyjBASb1FaOGYZNYvPBCL.png?r=54d"></img></>}
              <center>
                <p style={{ color:"white",marginTop:"10px",marginLeft:"30px"}}>
                  {e.name}
                </p>
              </center>
              </div>
