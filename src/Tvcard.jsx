  ...
  return (
    <div>
      {type ? (
        ...
        <div  className={Hstyle.mainn}>
          {/* <ReactPlayer url='https://www.youtube.com/watch?v=uGXB1PFg7E0'height="100%" width="100%" playing={true} controls={false}></ReactPlayer>*/}
          <Row className={Hstyle.mainrow}>
            <Col>
              <div className={Hstyle.con}>
                <img src="https://occ-0-2991-2164.1.nflxso.net/dnm/api/v6/tx1O544a9T7n8Z_G12qaboulQQE/AAAABZ1Nl3yLPBJrD8hsIB05BVnLby6ihbyAYDJAbc9-zoVUn-yS0fOv5S89cCMCjqpn5IaBL77Xsr4bcnEEOMWKA38zo7a5b28bIrHA2216e6EPG93T06RCVvAgO5IWKzHH4ky7bizAwGlJJqBC5GZBVYIiAi2NDXWzz7CbXP4TffwcULgzT9jy.webp?r=1af" className={Hstyle.logo}></img>
                <br></br>
                <h5 className="my-3" style={{ width: "500px", color: "white" }}>
                Follows the life of pop star duo Amar Singh Chamkila and Amarjot Kaur, whose songs that were social commentaries or devotionals became massive hits in the 80s.
                </h5>
                <Row style={{ width: "379px" }}>
                  <Col>
                    {" "}
                    <Link to="/play?link=https://www.youtube.com/watch?v=uGXB1PFg7E0&t=24s">
                      <button className={Hstyle.btn1}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="40"
